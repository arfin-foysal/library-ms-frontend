...
import { usePublisharCreateOrUpdateMutation } from "../../../../../services/publisherApi";
const EditPublisher = ({ handleClose, param }) => {
  const [publisharCreateOrUpdate, res] = usePublisharCreateOrUpdateMutation();
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      formData.append("establish", values.establish);
      formData.append("is_show", values.is_show);
      formData.append("is_active", values.is_active);
      resetForm();

      try {
        const result = await publisharCreateOrUpdate(formData).unwrap();
