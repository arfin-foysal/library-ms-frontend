...
import { useGetCategoryListQuery, useSubCategoryCreateOrUpdateMutation } from "../../../../../services/categoryApi";


const EditSubCategory = ({ handleClose, param }) => {
  const [subCategoryCreateOrUpdate, res] = useSubCategoryCreateOrUpdateMutation();
